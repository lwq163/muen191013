...
class messageBoard extends Component {
    ...
    render() {
        return (
            <div className="rooot">
              <Header title="留言板" flag={true} routers={this.props.history} />
              <span className="spans">留言</span>
                <div className="boody">
                  <h2 className="top">顶置</h2>
                        ...
                        <h2 className="bottom">全部留言</h2>
                    {
                      this.state.data.map((item,index)=>(
                        <div className="txt" key={index} onClick={()=>this.props.history.push("/messageBoardDetails")}>
                          <p>
                          <img src={item.img} alt='' /> <span>{item.title}</span>
